...
def filter_property_query(
    ...
    if query_params.price_per_square_feet_min is not None:
        query = query.filter(
            Property.price_per_square_feet >= query_params.price_per_square_feet_min
        )
    if query_params.price_per_square_feet_max is not None:
        query = query.filter(
            Property.price_per_square_feet <= query_params.price_per_square_feet_max
        )
